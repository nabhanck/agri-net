...
import { Sprout, Globe, MapPin, LayoutDashboard, ChevronDown, Plus } from 'lucide-react';
        ...
        {farmsList && farmsList.length > 0 ? (
          <div className="flex items-center gap-2">
            ...
            {/* <Link
              ...
              className="hidden md:flex items-center gap-1 px-2.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-colors"
            >
